...
DEFAULT_CASES = [
    ...
    SmokeCase(
        ...
        outputs=["video"],
        tier="experimental",
        notes="Expected failure sample for yt-dlp Douyin extraction: the same short-link works through browser_probe, but yt-dlp currently asks for fresh cookies on the VPS.",
        expect_success=False,
    ),
    SmokeCase(
        name="douyin-public-browser-video",
        url="https://v.douyin.com/BgPNNVe/",
        discovery="browser",
        platform_hint="douyin",
        outputs=["video"],
        tier="experimental",
        notes="Browser probe public Douyin short-link sample. This route captures signed DOM/network media URLs and must convert them immediately.",
    ),
    SmokeCase(
    ...
    SmokeCase(
        ...
        outputs=["video"],
        tier="experimental",
        notes="Kuaishou short-video sample. yt-dlp/you-get/streamlink do not handle it, but browser_probe can capture a short-lived signed MP4; select and convert immediately.",
        expect_success=False,
    ),
    SmokeCase(
        name="kuaishou-public-browser-video",
        url="https://www.kuaishou.com/short-video/3x2wdee2f2ud7ac",
        discovery="browser",
        platform_hint="kuaishou",
        outputs=["video"],
        tier="experimental",
        notes="Browser-only Kuaishou short-video sample. Signed CDN URLs expire quickly, so this is useful for validating immediate conversion behavior.",
        expect_success=False,
    ),
    SmokeCase(
