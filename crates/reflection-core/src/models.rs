...
impl PlatformHint {
    ...
    pub fn as_str(self) -> &'static str {
        match self {
            ...
            Self::ArchiveIt => "archive_it",
            Self::PermaCc => "perma_cc",
            Self::ArchiveToday => "archive_today",
            Self::Ghostarchive => "ghostarchive",
            Self::Webcitation => "webcitation",
    ...
    pub fn parse(value: &str) -> Option<Self> {
        match value {
            ...
            "peertube" => Some(Self::Peertube),
            "archive_org" | "archive" | "internet_archive" => Some(Self::ArchiveOrg),
            "wayback" | "web_archive" | "wayback_machine" | "web_archive_org" => {
                Some(Self::Wayback)
            }
            "archive_it" | "archiveit" => Some(Self::ArchiveIt),
            "perma_cc" | "perma" => Some(Self::PermaCc),
            "archive_today" | "archive_ph" | "archive_is" => Some(Self::ArchiveToday),
            "ghostarchive" => Some(Self::Ghostarchive),
            "webcitation" | "webcite" => Some(Self::Webcitation),
            "memento" | "mementoweb" => Some(Self::Memento),
            "wikimedia" | "commons" | "wikimedia_commons" => Some(Self::Wikimedia),
            ...
            "mixcloud" => Some(Self::Mixcloud),
            "niconico" | "nicovideo" => Some(Self::Niconico),
            "fc2" => Some(Self::Fc2),
